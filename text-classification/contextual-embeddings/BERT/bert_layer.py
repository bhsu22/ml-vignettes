"""Builds a reusable Keras Layer out of a BERT module.

Implements custom Keras Layer using a BERT module to allow 
more control over the computational graph.

Ref: 
    https://github.com/gaphex/bert_experimental/tree/master/bert_experimental/finetuning
